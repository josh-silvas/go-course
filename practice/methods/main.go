// Methods Example: In this example, we will be defining an IP address structure and attaching a
...
// TODO: 1. Define the struct with data types for 'IP' and 'Netmask' string values.
type Address struct {
}
